...
::загружаем данные по атланту 46
...
::загружаем данные по стройкому 57
...
::@php.exe script.php [fcomp] 57 [type] "import_lc_from_elc" [from] "h:\Program\Otchets\gis\in\ready\57\20161124\Помещения и ЕЛС от 24.11.2016 08-12_Результат.xlsx"

::загружаем данные по технику 45
...
::загружаем данные по западу 58
::@php.exe script.php [fcomp] 58 [type] "import_lc_from_result" [from] "h:\Program\Otchets\gis\in\ready\58\Шаблон импорта ЛС-10.0.2.1_Результат.xlsx"
::@php.exe script.php [fcomp] 58 [type] "import_lc_from_elc" [from] "h:\Program\Otchets\gis\in\46\Помещения и ЕЛС от 18.11.2016 15-23_Результат.xlsx"
...
@SET opt_uk=[fcomp] 57 [fperiod] 2016.10 [street] пром%% [house] 12
